...
# -----------------------------------------------
# Experiment configurations: Vectorizer & Stopwords
configs = [
    ("BoW", True),
    ("TFIDF", True),
    ("BoW", False),
...
for vec_type, stopwords_option in configs:
    ...
    for name, model in models.items():
        try:
            ...
            print(f"{name:20s} | Acc: {acc*100:.2f}% | AUC: {auc if auc else 'N/A'} | Bias: {bias*100:.2f}% | Var: {var*100:.2f}%")
